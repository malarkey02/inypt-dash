...
try {
    mongoose.connect('mongodb+srv://admin-harsh:7hoPUeNHT2b42upX@cluster0.8y5it.mongodb.net/InYPTUsers?retryWrites=true&w=majority', {useNewUrlParser: true, useUnifiedTopology: true});
